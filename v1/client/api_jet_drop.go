...
Gets an array of jet drops given a &#x60;jet_id&#x60; as a path parameter. Optionally, specify filtering and pagination parameters. For more information, refer to the [filtering, pagination, sorting section](#section/Insolar-Explorer-API-documentation/Filtering-pagination-sorting).
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param jetId Jet ID.
...
Gets an array of jet drops given a &#x60;pulse_number&#x60; as a path parameter. Optionally, specify filtering and pagination parameters. For more information, refer to the [filtering, pagination, sorting section](#section/Insolar-Explorer-API-documentation/Filtering-pagination-sorting).
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
