...
*/
func (a *RequestAndResultApiService) OriginalRequestByObject(ctx _context.Context, objectReference string, localVarOptionals *OriginalRequestByObjectOpts) (RequestResponse200, *_nethttp.Response, error) {
	var (
