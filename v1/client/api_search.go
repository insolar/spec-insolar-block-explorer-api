...
/*
Search Search
Searches for an entity by its identifier.  Entities and their identifiers may be one of the following: * Record — record reference * State - state by object * Original-Request -  it is request from outside * Request - it is request inside the platform * Jet drop — jet drop ID (combination of &#x60;jet_id&#x60; and &#x60;pulse_number&#x60;) * Pulse — pulse number * Lifeline — object reference  Search takes any of the identifiers above as the &#x60;value&#x60; parameter, determines the identifier type and finds the corresponding entity. If the entity exists, search returns its type and meta-information. 
