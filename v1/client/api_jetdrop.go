...
*/
func (a *JetdropApiService) JetDropsByPulseNumber(ctx _context.Context, pulseNumber int32, fromItem string, localVarOptionals *JetDropsByPulseNumberOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
