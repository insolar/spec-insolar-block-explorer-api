...
/*
Pulses Pulses
Gets an array of pulses. Optionally, specify filtering and pagination parameters. For more information, refer to the [filtering, pagination, sorting section](#section/Insolar-Explorer-API-documentation/Filtering-pagination-sorting).
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
