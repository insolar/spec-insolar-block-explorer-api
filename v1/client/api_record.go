...
Gets records by &#x60;jet_drop_id&#x60; and based on filtering and pagination parameters.
 ...
 * @param "FromIndex" (optional.String) -  Specific index to paginate from. Index is a combination of `pulse_number` with order (record number in a jet drop).
...
Gets a lifeline with all its records by &#x60;object_reference&#x60; and based on filtering, pagination and sorting parameters.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 ...
 * @param "Offset" (optional.Int32) -  Number of entries to skip from the starting point (`from_*`).
 * @param "FromIndex" (optional.String) -  Specific index to paginate from. Index is a combination of `pulse_number` with order (record number in a jet drop).
 * @param "SortBy" (optional.String) -  Sorting direction based on index. Index is a combination of `pulse_number` with order (record number in a jet drop).
