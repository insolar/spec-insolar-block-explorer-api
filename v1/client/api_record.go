...
Gets an array of records of a jet drop given a &#x60;jet_drop_id&#x60; as a path parameter. Optionally, specify filtering and pagination parameters. For more information, refer to the [filtering, pagination, sorting section](#section/Insolar-Explorer-API-documentation/Filtering-pagination-sorting).
...
Gets an array of records of a lifeline given an &#x60;object_reference&#x60; as a path parameter. Optionally, specify filtering and pagination parameters. For more information, refer to the [filtering, pagination, sorting section](#section/Insolar-Explorer-API-documentation/Filtering-pagination-sorting).
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
